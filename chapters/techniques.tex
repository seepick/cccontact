...
Dancing in the negative space basically means entering the kinesphere of another person without yet engaging in touch.
This is a common way to non-verbally invite someone to dance together, at a jam for example.

\subsection{Others}\label{subsec:others}

\begin{itemize}
    \item \textbf{Body-surfing}: One person rolls on the floor, the other perpendicularly rolling over.
